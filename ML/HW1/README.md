...
Сделано приложение streamlit. Оно позволяет загрузить csv файл с параметрами машины и получить прогнос стоимости. csv предполагается в очищеном формате по сравнению с исходным датасетом для обучения. 
